...
export default function Reconstruction({
  ...
  return (
    <section className="px-[120px] py-[50px] max-md:px-6 max-md:py-10">
      ...
      <div className="mt-[50px] grid grid-cols-3 gap-5 max-lg:grid-cols-1 max-md:mt-8">
        {groups.map((group, index) => (
          <AnimatedSection key={group.title} delay={index * 0.08} className="flex h-full flex-col border border-black/10 bg-[#F6F1ED] p-8 max-md:p-6">
